...
export const PriceOfferAddPage2 = ({ offer }: { offer: PriceOfferDto }) => {
          ...
          <tfoot className="bg-gray-50">
            ...
            <tr>
              ...
              <td className="p-2 border font-bold  text-red-700  text-right">
                  {/* <input
                    {...register("toplamTutar" as const, {
                      valueAsNumber: true,
                    })}
                      type="number"
                    // onChange={(e)=> {total= Number(e.target.value);   setValue("toplamTutar", total)} }
                      className="border p-1 rounded w-full"
                    /> */}
                  {total.toFixed()}{" "}
              </td>
