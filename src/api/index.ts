export const URL3 = 'http://192.168.1.52/api'
export const URL2 = 'http://192.168.4.59:5254'
export const URL4='/api'
...
export const CMMFAILURE_DESCRIPTION = `${URL}/CMMFailureState/QualityDescription`;
...
//SURVEY
export const SURVEY_GETALL = `${URL}/Survey/GetAll`;
export const SURVEY_GETALLSURVEYANSWERS = `${URL}/Survey/GetAllSurveyAnswers`;
export const SURVEY_GET = `${URL}/Survey/Get`;
export const SURVEY_FILL = `${URL}/Survey/Fill`;
export const SURVEY_CREATE = `${URL}/Survey/Create`;
export const SURVEY_DELETE = `${URL}/Survey/Delete`;

export const PERSONEL_GETALLNAMES = `${URL}/Personel/GetAll`;

export const EDUCATION_PLAN_CREATE = `${URL}/Education/Create`;
export const EDUCATION_PLAN_GETALL = `${URL}/Education/GetAll`;
export const EDUCATION_PLAN_GET = `${URL}/Education`;
export const EDUCATION_PLAN_UPDATE = `${URL}/Education/Update`;
export const EDUCATION_PLAN_DELETE = `${URL}/Education/Delete`;
export const EDUCATION_PLAN_ASSIGN = `${URL}/Education/Assign`;
export const EDUCATION_PLAN_MAPPING = `${URL}/Education/education_mappings`;


export const DOCUMENT_UPLOAD = `${URL}/documents/upload`;


export const KYSDOCUMENT_GETALL =`${URL}/kysDocument/GetAll`
export const KYSDOCUMENT_UPLOAD = `${URL}/kysDocument/upload`;
export const KYSDOCUMENT_DOWNLOAD = `${URL}/kysDocument/download`;
export const KYSDOCUMENT_DELETE = `${URL}/kysDocument/delete`;
export const KYSDOCUMENT_CREATEUPDATE = `${URL}/kysDocument/create`;

export const STAFFLEAVE_CREATE = `${URL}/staffleave/create`;
export const STAFFLEAVE_GETALL = `${URL}/staffleave/getall`;
export const STAFFLEAVE_DELETE = `${URL}/staffleave/delete`;

export const OVERTIME_CREATE = `${URL}/overtime/create`;
export const OVERTIME_GETALL = `${URL}/overtime/getall`;
export const OVERTIME_DELETE = `${URL}/overtime/delete`;
